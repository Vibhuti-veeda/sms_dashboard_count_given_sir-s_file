    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        @if((Auth::guard('admin')->user()->role_id == 1) || (Auth::guard('admin')->user()->role_id == 2 )|| (Auth::guard('admin')->user()->role_id == 3) || (Auth::guard('admin')->user()->role_id == 16) || (Auth::guard('admin')->user()->role_id == 17) || (Auth::guard('admin')->user()->role_id == 18) || (Auth::guard('admin')->user()->role_id == 19) || (Auth::guard('admin')->user()->role_id == 20) || (Auth::guard('admin')->user()->role_id == 21))
            ...
            <div class="row allView">
                ...
                @if((Auth::guard('admin')->user()->role_id == 1) || (Auth::guard('admin')->user()->role_id == 2) || (Auth::guard('admin')->user()->role_id == 3) || (Auth::guard('admin')->user()->role_id == 6) || (Auth::guard('admin')->user()->role_id == 10) || (Auth::guard('admin')->user()->role_id == 16) || (Auth::guard('admin')->user()->role_id == 17) || (Auth::guard('admin')->user()->role_id == 18) || (Auth::guard('admin')->user()->role_id == 19) || (Auth::guard('admin')->user()->role_id == 20) || (Auth::guard('admin')->user()->role_id == 21))
