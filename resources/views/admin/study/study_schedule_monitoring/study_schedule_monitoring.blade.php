                                    ...
                                    @foreach($studies as $sk => $sv)
                                        @if(count($sv->schedule)>0)
                                            <tr>
                                                ...
                                                @if((Auth::guard('admin')->user()->role_id == 5) || (Auth::guard('admin')->user()->role_id == 6) || (Auth::guard('admin')->user()->role_id == 10) || (Auth::guard('admin')->user()->role_id == 16) || (Auth::guard('admin')->user()->role_id == 17) || (Auth::guard('admin')->user()->role_id == 18) || (Auth::guard('admin')->user()->role_id == 19) || (Auth::guard('admin')->user()->role_id == 20) || (Auth::guard('admin')->user()->role_id == 21))
                                                    <td>                                                
                                                        <span>
