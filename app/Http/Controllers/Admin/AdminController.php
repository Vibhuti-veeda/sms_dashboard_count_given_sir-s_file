...
class AdminController extends GlobalController
{
    ...
    public function index(){
        ...
        $crlocation = Study::where('cr_location',Auth::guard('admin')->user()->location_id)->where('is_delete', 0)->where('is_active', 1)->get('id')->toArray();
        $brlocation = Study::where('br_location',Auth::guard('admin')->user()->location_id)->where('is_delete', 0)->where('is_active', 1)->get('id')->toArray();
    ...
    public function changeDashboardView(Request $request){
        ...
        $crlocation = Study::where('cr_location',Auth::guard('admin')->user()->location_id)->where('is_active', 1)->where('is_delete', 0)->get('id')->toArray();
