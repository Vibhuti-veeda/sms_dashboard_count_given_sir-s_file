<?php
    ...
    Route::group(['prefix' => 'study-schedule-monitoring'], function () {
        ...
        Route::match(['get', 'post'],'/view/department-schedule-tracking-list', 'Study\StudyScheduleMonitoringController@departmentScheduleTrackingList')->name('admin.departmentScheduleTrackingList');
        Route::match(['get', 'post'],'/view/department-activity-tracking-list', 'Study\StudyScheduleMonitoringController@departmentActivityTrackingList')->name('admin.departmentActivityTrackingList');
    });
